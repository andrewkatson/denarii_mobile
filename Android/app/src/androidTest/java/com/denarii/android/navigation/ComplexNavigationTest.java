...
public class ComplexNavigationTest {
    ...
    private String createWallet(String name, String email, String password, String walletName, String walletPassword) {
        return createWallet(name, email, password, walletName, walletPassword, false);
    }

    private String createWallet(
            String name, String email, String password, String walletName, String walletPassword, boolean getAddress) {
    ...
    private String strictlyCreateWallet(String walletName, String walletPassword, boolean getAddress) {
        ...
        int address = 0;
        Function<Integer, String> getAddressString = (addressInt) -> String.format("Own Address: %s", addressInt);
        boolean addressNotFound = true;

        while (addressNotFound) {
            try {
                onView(withId(R.id.opened_wallet_address_text_view)).check(matches(hasValueEqualTo(getAddressString.apply(address))));
    ...
    private void sendDenarii(
        ...
        String sendToAddress = createWallet(otherName, otherEmail, otherPassword, otherWalletName, otherWalletPassword, true);
        ...
        onView(withId(R.id.opened_wallet_to_edit_text)).perform(typeText(sendToAddress), closeSoftKeyboard());
