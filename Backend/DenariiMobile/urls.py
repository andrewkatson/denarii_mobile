...
urlpatterns = [
    ...
    # This one the amount and asking_price are strings but really are doubles. buy_regardless_of_price is a boolean. fail_if_full_amount_isnt_met is a boolean
    path(
        'buy_denarii/<str:user_id>/<str:amount>/<str:bid_price>/<str:buy_regardless_of_price>/<str:fail_if_full_amount_isnt_met>/',
        views.buy_denarii),
    ...
    path(
        'set_credit_card_info/<str:user_id>/<str:card_number>/<str:expiration_date_month>/<str:expiration_date_year>/<str:security_code/',
        views.set_credit_card_info),
    ...
    # Returns if the individual user has been verified. It can will return one of three answers. "is_verified",
    # "is_not_verified", "failed_verification", and "verification_pending".
    ...
    path(
        'verify_identity/<str:user_id>/<str:first_name>/<str:middle_name>/<str:last_name>/<str:email>/<str:phone>/<str:zipcode>/<str:dob>/<str:ssn>/<str:work_locations>/',
        views.verify_identity),
